            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="nav nav-list flex-column primary">
                        <li class="nav-item"><a class="nav-link" href="./"><i class="fas fa-caret-right text-dark"></i> Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link" href="profile-settings"><i class="fas fa-caret-right text-dark"></i> User Profile</a></li>
                    </ul>
                </div>
            </div>
        </div>
